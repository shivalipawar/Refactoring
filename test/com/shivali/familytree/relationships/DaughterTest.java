...
public class DaughterTest {
    ...
    public void initialize() {
        ...
        daughter = new Daughter(familyRootNode);
    }

    @Test
    public void getPersonsShouldReturnCorrectDaughter() throws CustomException {
        ArrayList expected = new ArrayList();
        expected.add(level1Family4.bornChild);
        ArrayList result = (ArrayList) daughter.getPersons(father.getName());
