...
public class MaternalAuntTest{
    ...
    public void initialize() {
        ...
        maternalAunt = new MaternalAunt(familyRootNode);
    }

    @Test
    public void getPersonsShouldReturnCorrectMaternalAunt() throws CustomException {
        level1Family4.addChild(level2Family3);
        level1Family4.addChild(level2Family4);
        ArrayList expected = new ArrayList();
        ArrayList result = (ArrayList<Person>) maternalAunt.getPersons(level2Family3.bornChild.getName());
